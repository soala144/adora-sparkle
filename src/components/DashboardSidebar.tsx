    ...
    <>
      ...
      >
        <div className="flex flex-col h-full">
            ...
            {sidebarLinks.map((link, index) => {
              ...
              return (
                <Link
                  ...
                  href={link.href}
                  onClick={() => setIsMobileMenuOpen(false)}
                  className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-all duration-200 transform hover:scale-105 ${
                    isActive
          ...
          {/* Settings Section */}
          <div
            className="p-6 border-t border-gray-200 animate-fade-in-up"
            style={{ animationDelay: "600ms" }}
          >
            <div className="px-4 py-3 bg-blue-50 rounded-lg border border-blue-200 hover:shadow-md transition-all duration-300 transform hover:scale-105">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-blue-100 rounded-lg">
                  <IoMdSettings size={18} className="text-blue-600" />
                </div>
                <div>
