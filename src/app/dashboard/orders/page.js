...
const initialOrders = [
  { id: 'ORD-1001', customer: 'Jane Doe', date: '2025-07-19', status: 'Pending', total: '₦77,900.00' },
  { id: 'ORD-1002', customer: 'John Smith', date: '2025-07-18', status: 'Paid', total: '₦25,000.00' },
  { id: 'ORD-1003', customer: 'Mary Johnson', date: '2025-07-17', status: 'Delivering', total: '₦18,500.00' },
  { id: 'ORD-1004', customer: 'Chris Lee', date: '2025-07-16', status: 'Completed', total: '₦10,000.00' },
];
...
const OrdersPage = () => {
  ...
  return (
    <div className="bg-[#F8F7FC] w-full min-h-screen p-8">
      <h1 className="text-3xl font-extrabold mb-8 text-pink-600 tracking-tight">Orders</h1>
        ...
        <table className="w-full text-left border-separate border-spacing-y-2">
          ...
          <tbody>
            {orders.map((order) => {
              ...
              return (
                <tr key={order.id} className="bg-gray-50 hover:bg-pink-50 transition rounded-lg">
                  <td className="py-3 px-2 font-semibold text-pink-600">{order.id}</td>
